...
import { Github, GitCommit, GitBranch, Star, GitFork, ExternalLink, Calendar, Clock } from "lucide-react"
...
export default function GitHubActivity() {
  ...
  const getEventDescription = (event: GitHubData["events"][0]) => {
    switch (event.type) {
      case "PushEvent":
        ...
        return `Pushed commits: ${commitMessage.length > 50 ? commitMessage.substring(0, 50) + "..." : commitMessage}`
      case "CreateEvent":
      ...
      <section id="github" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-4">Loading GitHub activity...</p>
          </div>
        </div>
      </section>
    )
      ...
      <section id="github" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Unable to load GitHub activity at the moment.</p>
  ...
  return (
    <section id="github" ref={sectionRef} className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
        ...
        >
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">GitHub Activity</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Card className="bg-muted/30 border-border text-center">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-primary mb-2">{githubData.user.public_repos}</div>
                <div className="text-muted-foreground">Public Repositories</div>
              </CardContent>
            </Card>
            <Card className="bg-muted/30 border-border text-center">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-primary mb-2">{githubData.user.followers}</div>
                <div className="text-muted-foreground">Followers</div>
              </CardContent>
            </Card>
            <Card className="bg-muted/30 border-border text-center">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-primary mb-2">{githubData.user.following}</div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-3 mt-1">
                          <p className="text-xs text-muted-foreground">{event.repo}</p>
            ...
            <Card className="bg-muted/30 border-border">
              ...
              <CardContent className="space-y-4">
                {githubData.repositories.map((repo) => (
                  <div key={repo.id} className="p-3 rounded-lg bg-background/50">
