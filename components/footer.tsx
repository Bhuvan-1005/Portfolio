      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-foreground">{portfolioConfig.personal.name}</h3>
            <p className="text-muted-foreground leading-relaxed">
              {portfolioConfig.personal.title} passionate about creating exceptional digital experiences.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-muted-foreground">{portfolioConfig.personal.email}</p>
